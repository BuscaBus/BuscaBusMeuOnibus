...
public class Act_Empresas_CFenix extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act__empresas__cfenix);
        ...
        linha.add("100 - Madrugadao Centro-UFSC");
        ...
        adaptador = new ArrayAdapter<String>(Act_Empresas_CFenix.this, android.R.layout.simple_list_item_1, linha);
        ...
        this.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView adapterView, View view, int position, long ld) {
                Intent intent = new Intent(Act_Empresas_CFenix.this, Act_Empresas_CFenix_Horarios.class);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if(linha.contains(query)){
                    ...
                    Toast.makeText(Act_Empresas_CFenix.this, "Linha não encontrada",Toast.LENGTH_LONG).show();
                }
                return false;
            }
